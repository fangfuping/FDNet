...
class Options():
    ...
    def init(self, parser):        
        ...
        parser.add_argument('--nepoch', type=int, default=161, help='training epochs')
        ...
        parser.add_argument('--pretrain_weights',type=str, default='./logs/UformerBL1/motiondeblur/SIDD/Uformer_B_/models/model_epoch_100.pth', help='path of pretrained_weights')
        ...
        parser.add_argument('--regulation', type=str, default='l1')

        # args for saving 
        parser.add_argument('--save_dir', type=str, default ='./logs/Ex3/PISNet',  help='save dir')
        ...
        parser.add_argument("--distribute",action='store_true',default=False,help='whether using multi gpu train')
...
class HWOptions():
    ...
    def init(self, parser):
        # global settings
        parser.add_argument('--batch_size', type=int, default=4, help='batch size')
        parser.add_argument('--nepoch', type=int, default=301, help='training epochs')
        parser.add_argument('--train_workers', type=int, default=0, help='train_dataloader workers')
        parser.add_argument('--eval_workers', type=int, default=0, help='eval_dataloader workers')
        parser.add_argument('--dataset', type=str, default='SIDD')
        parser.add_argument('--pretrain_weights', type=str,
                            default='./logs/UformerBL1/motiondeblur/SIDD/Uformer_B_/models/model_epoch_100.pth',
        ...
        parser.add_argument('--mode', type=str, default='denoising', help='image restoration mode')
        parser.add_argument('--dd_in', type=int, default=1, help='dd_in')
        parser.add_argument('--regulation', type=str, default=' ')

        # args for saving
        parser.add_argument('--save_dir', type=str, default='./logs/HWNet', help='save dir')
        parser.add_argument('--save_images', action='store_true', default=False)
        parser.add_argument('--env', type=str, default='_', help='env')
        parser.add_argument('--checkpoint', type=int, default=20, help='checkpoint')
        ...
        # args for Uformer
        parser.add_argument('--norm_layer', type=str, default='nn.LayerNorm', help='normalize layer in transformer')
        parser.add_argument('--embed_dim', type=int, default=4, help='dim of emdeding features')
        parser.add_argument('--win_size', type=int, default=8, help='window size of self-attention')
        parser.add_argument('--token_projection', type=str, default='linear', help='linear/conv token projection')
        parser.add_argument('--token_mlp', type=str, default='leff', help='ffn/leff token mlp')
        parser.add_argument('--att_se', action='store_true', default=False, help='se after sa')
