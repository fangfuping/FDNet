...
def main():
    ...
    parser.add_argument('--weights',
                        default='../train/logs/Ex3/PISNet/motiondeblur/SIDD/UNet_/models/model_epoch_120.pth',
    ...
    for idx in range(len(x)):
        ...
        name = r'G:\ffp\ExperimentPaper\selfsupervised\result\ex3\PISNet' + '/' + str(idx) + '.tif'
        pp.save(name)
    ...
    name2 = r'G:\ffp\ExperimentPaper\selfsupervised\result\ex3' + '/' + 'PISNet' + '.mat'
