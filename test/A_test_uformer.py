...
def main():
    ...
    parser.add_argument('--weights',
                        default='../train/logs/Uformer/motiondeblur/SIDD/Uformer_/models/model_epoch_120.pth',
    ...
    for idx in range(len(x)):
        ...
        name = r'G:\ffp\ExperimentPaper\selfsupervised\result\ex1\Uformer' + '/' + str(idx) + '.tif'
        pp.save(name)
        import cv2
    ...
    name2 = r'G:\ffp\ExperimentPaper\selfsupervised\result\ex1' + '/' + 'Uformer' + '.mat'
