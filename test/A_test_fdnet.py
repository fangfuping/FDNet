...
def main():
    ...
    parser.add_argument('--weights',
                        default='../train/logs/FDnet/motiondeblur/SIDD/Uformer_B_/models/model_epoch_220.pth',
    ...
    for idx in range(len(x)):
        ...
        # name = r'G:\ffp\result\denosing\tfd/fdnet/test1/DncnnTiff' + '/' + str(idx) + '.tif'
        # pp.save(name)

        max1 = np.max(img_H)
        picture1 = (255 * img_H/(max1)).astype('uint8')
        pp1 = Image.fromarray(picture1)
        name = r'G:\ffp\result\denosing\tfd/fdnet/test1/label' + '/' + str(idx) + '.png'
        pp1.save(name)
        picture1 = (255 * img_net/(max1)).astype('uint8')
        pp1 = Image.fromarray(picture1)
        name = r'G:\ffp\result\denosing\tfd/fdnet/test1/net' + '/' + str(idx) + '.png'
        pp1.save(name)

        picture1 = (255 * img_org / (np.max(img_org))).astype('uint8')
        pp1 = Image.fromarray(picture1)
        name = r'G:\ffp\result\denosing\tfd/fdnet/test1/data' + '/' + str(idx) + '.png'
        pp1.save(name)
    ...
    name2 = r'G:\ffp\result\denosing\tfd/fdnet/test1' + '/' + 'epoch100' + '.mat'
